...
export default function Command() {
  ...
  const getSourceColor = (source: MCPProcess["source"]): Color => {
    switch (source) {
      case "claude-desktop":
        return Color.Orange;
      case "vscode":
  ...
  const getRAMColor = (ramMB: number): Color => {
    if (ramMB >= 500) return Color.Red;
    if (ramMB >= 200) return Color.Orange;
    if (ramMB >= 100) return Color.Yellow;
    return Color.Green;
  };
              ...
              accessories={[
                ...
                },
                {
                  tag: {
                    ...
                    color: process.cpuPercentage > 50 ? Color.Red : Color.SecondaryText,
                  },
